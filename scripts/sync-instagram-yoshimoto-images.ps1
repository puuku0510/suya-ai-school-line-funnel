...
$map = @{
    ...
    34 = @('1Z9VB42yiv1z89nCcPCO37reyGAPcLgtf', 'いよいよ明日開催・AIでひとり起業攻略法', 'f4b7db08-16a9-43f0-aaf3-caa0cb744151.png')
    35 = @('1XtcF3PKgU1v3is1AMfU6Y2u-m4SIP4u5', 'いよいよ本日開催・まだ申込可能・参加者限定5特典', '9994c0c9-dd85-4813-9d25-adadd2687812.png')
    37 = @('1LzdwxCZo6t1L1_48Qto7ZCfEm0To2kw6', 'いよいよ本日開催・まだ申込可能・参加者限定5特典（人物なし版）', 'e012febb-3b0a-4b8a-8ebb-91255149c38f.png')
    38 = @('1178CLZ6IuL48LtOLodOt42idmxdI649q', '20:00開始・AIでインスタ集客する方法・ライブ参加案内', 'edab37b2-5f31-4063-acc0-498b0d4d1096.png')
    44 = @('1yzVOowf9tGuaAintrOgi6rdIDqiE9tSt', 'セミナー不参加者へ3日間限定の録画公開', '6c890565-c8b5-4e58-948d-db5502dabbed.png')
    69 = @('1zDdYksox-PG8m4w80F3160DbK4iy8DOM', '動画視聴者へ30分無料個別面談', 'b8df8636-aa27-4f4a-a7a1-7ce2e3631b87.png')
    70 = @('1Ohu9GY2Tfou6npPdp-9bE4CUJj4kzLxV', 'セミナー参加者へ30分無料個別面談', '6641105e-3faa-4150-9a5f-6c64d87ba6dd.png')
    79 = @('1YCKctnlBFecaORB5B8Aa4z0ZnoWchcW6', '個別面談の予約ありがとうございます', '54f809d5-cf88-40f4-88b3-4147a1ec8fe7.png')
    84 = @('1rO5MZ9rDi6NHj-7zdqZOQs7VtrrLGfpn', 'LINEオープンチャット・無料勉強会の案内', '生成画像1.png')
}
